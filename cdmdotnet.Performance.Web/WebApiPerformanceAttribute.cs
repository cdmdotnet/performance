...
namespace cdmdotnet.Performance.Web
{
    ...
    public class WebApiPerformanceAttribute : ActionFilterAttribute
    {
        ...
        /// </summary>
        public const String ActionType = "API";
        ...
        {          
            ...
            ActionInfo info = new ActionInfo(processId, categoryName, ActionType, controllerName, actionName, httpMethod, parameterString);
