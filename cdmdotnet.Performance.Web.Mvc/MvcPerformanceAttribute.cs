...
namespace cdmdotnet.Performance.Web.Mvc
{
	/// <summary>
	...
	public class MvcPerformanceAttribute : ActionFilterAttribute
	{
		...
		/// </summary>
		public const String ActionType = "MVC";
		...
		public override void OnActionExecuting(ActionExecutingContext filterContext)
		{
			...
			if (actionDescriptor.GetCustomAttributes(typeof(DoNotTrackPerformanceAttribute), true).Length > 0 || actionDescriptor.ControllerDescriptor.GetCustomAttributes(typeof(DoNotTrackPerformanceAttribute), true).Length > 0)
			{
				return;
			}
		...
		private ActionInfo CreateActionInfo(ActionExecutingContext actionContext)
		{
			...
			ActionInfo info = new ActionInfo(processId, categoryName, ActionType,
