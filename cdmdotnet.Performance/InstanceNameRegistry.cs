...
namespace cdmdotnet.Performance
{
    ...
    public static class InstanceNameRegistry
    {
        ...
        private static readonly Dictionary<String, String> InstanceNames = new Dictionary<String, String>();
        private static readonly Object LockObject = new Object();
        private static int _methodCounter = 0;
                ...
                if (InstanceNames.ContainsKey(rawInstanceName) == false)
                {
                    ...
                    else
                    {
                        ...
                        String sanitizedName = String.Format("{0}{1:###}",
                            rawInstanceName.Substring(0, 125), _methodCounter++);
