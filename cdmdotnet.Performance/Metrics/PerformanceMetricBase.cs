...
namespace cdmdotnet.Performance.Metrics
{
	...
	public abstract class PerformanceMetricBase : IDisposable
	{
		...
		/// <summary>
		/// Helper method to initialize a performance counter
		/// </summary>
		/// <param name="categoryName"></param>
		/// <param name="counterName"></param>
		/// <param name="instanceName"></param>
		/// <returns></returns>
		protected PerformanceCounter InitializeCounter(String categoryName, String counterName, String instanceName)
		{
			PerformanceCounter counter = new PerformanceCounter();
			counter.CategoryName = categoryName;
			counter.CounterName = counterName;
			// Performance counters have a limit of 127 characters so this needs to be limited
			counter.InstanceName = instanceName.Substring(0, instanceName.Length > 127 ? 127 : instanceName.Length);
